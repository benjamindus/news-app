...
claude --model sonnet -p "Search for this week's biggest news and update weekly_news.md with: 15 top geopolitical stories and 15 top financial stories from the past 7 days. EXCLUDE all sports news.
