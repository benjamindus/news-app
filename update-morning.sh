...
$TIMEOUT_CMD claude --model sonnet -p "Search for news from the LAST 24 HOURS ONLY and update morning_briefing.md with: 10 top geopolitical stories and 10 top financial stories. IMPORTANT: Check publication dates - REJECT any story older than 24 hours. Only include breaking news and stories published today. EXCLUDE all sports news.
